...
###### METROSTROI AUTOMATIC VOLTAGE SETTER [MAVS] ########
...
timer.Simple(0.5, function()
  ...
  MsgC(Color(255, 0, 0), "[MAVS] Scaning for the current map to set the Voltage.")
  ...
  local VoltageTbl = {
    ...
    ["gm_metro_ruralline_v29"] = 700,
    ["gm_metro_ruralline_v29_old"] = 700,
    ["gm_metro_ruralline_v3"] = 700,
    ["gm_metro_ruralline_v4"] = 830,
    ["gm_metro_ruralline_v29_snow"] = 700,
  ...
  if not VoltageTbl[map] then return end
  local voltage = VoltageTbl[map]
  print("Found " .. (map or "invalid map, Using Default voltage.") .. ", Setting wagon limit to " .. VoltageTbl[map])
  RunConsoleCommand("metrostroi_voltage", voltage)
end)